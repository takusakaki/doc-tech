...
** TODO 同一の名前のファイルを開くときバッファ名を分かりやすくする [4.2]
...
** TODO M-x occur 正規表現にマッチした行一覧を作成 [7.2]
/color-moccur.el も参照/
#+BEGIN_EXAMPLE
...
** TODO imenu 関数定義にジャンプ (現在のファイル内) [13.9]
...
** TODO ファイルに直接書き込まずメモを取る (ipa.el) [13.12]
